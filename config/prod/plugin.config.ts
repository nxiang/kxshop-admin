...
const chainWebpack: IConfig['chainWebpack'] = (config) => {
  ...
  //   rules[5],
  //   rules[6]
  //   // JSON.stringify(rules[4], null, 2),
  //   // JSON.stringify(rules[5], null, 2),
  //   // JSON.stringify(rules[6], null, 2),
  // )
  // 打印umi的webpack配置
  ...
  //         utils: {
  //           name: 'utils',
  //           test: /[\\/]node_modules[\\/](lodash|lodash-es|ahooks|@ahooksjs|axios|alife-logger|umi-request|qs|js-base64|query-string|core-js|hash.js|qr.js|moment)/,
  //           priority: 20
  //         },
  //         // node_modules中的其它
  //         vendors: {
