...
class MenuAdd extends PureComponent {
  ...
  render() {
    ...
    const Icon =
      Icons[
        getIconName(func.isEmpty(detail.source) ? 'setting' : detail.source)
      ]
    return (
              ...
              <Col span={10}>
                <FormItem {...formItemLayout} label="上级菜单">
                  {getFieldDecorator('parentId', {
                    initialValue:
                      detail.category === 2 ? detail.parentId : detail.id
                  })(
                    <TreeSelect
                ...
                <FormItem {...formItemLayout} label="菜单图标">
                  {getFieldDecorator('source', {
                    ...
                    <Search
                      prefix={
                        Icon ? <Icon /> : null
                        // <LegacyIcon type={func.isEmpty(detail.source) ? 'setting' : detail.source} />
                      }
                      placeholder="请选择菜单图标"
